...
<script>
  import cEditorLea from '@/components/c-editor-lea.vue'
  import cEditorItem from '@/components/c-editor-item.vue'
  import cEditorHardMode from '@/components/c-editor-hard-mode.vue'
  import cEditorFqa from '@/components/c-editor-fqa.vue'
  import cEditorAuthor from '@/components/c-editor-author.vue'
